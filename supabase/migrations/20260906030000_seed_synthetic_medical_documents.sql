...
INSERT INTO public.clinical_sources (
  ...
  ('e1111111-4444-4111-8111-000000000001', 'c1111111-1111-4111-8111-000000000001', 'historical_document', 'medical_documents', 'ramesh_docs_corpus', 'high', 'Uploaded historical cardiac and OPD paper records for Ramesh Kumar'),
...
INSERT INTO public.medical_documents (
  ...
  -- FLAGSHIP CASE 1: Ramesh Kumar (5 Documents)
  (
    'd1111111-1111-4111-8111-000000000001',
    'a1111111-1111-4111-8111-000000000001',
    'c1111111-1111-4111-8111-000000000001',
    'ramesh_opd_prescription_2022.pdf',
    'application/pdf',
    'medical-documents/a1111111-1111-4111-8111-000000000001/ramesh_opd_prescription_2022.pdf',
    'opd_prescription',
    'uploaded',
    'pending',
  ...
  (
    ...
    'a1111111-1111-4111-8111-000000000001',
    'c1111111-1111-4111-8111-000000000001',
    'ramesh_lab_report_2023.pdf',
    'application/pdf',
    'medical-documents/a1111111-1111-4111-8111-000000000001/ramesh_lab_report_2023.pdf',
    'lab_report',
    'uploaded',
    'pending',
    'e1111111-4444-4111-8111-000000000001',
  ...
  (
    ...
    'a1111111-1111-4111-8111-000000000001',
    'c1111111-1111-4111-8111-000000000001',
    'ramesh_ecg_cardiac_report_2024.pdf',
    'application/pdf',
    'medical-documents/a1111111-1111-4111-8111-000000000001/ramesh_ecg_cardiac_report_2024.pdf',
    'imaging_report',
    'uploaded',
    'pending',
    'e1111111-4444-4111-8111-000000000001',
  ...
  (
    ...
    'a1111111-1111-4111-8111-000000000001',
    'c1111111-1111-4111-8111-000000000001',
    'ramesh_discharge_summary_2018.pdf',
    'application/pdf',
    'medical-documents/a1111111-1111-4111-8111-000000000001/ramesh_discharge_summary_2018.pdf',
    'discharge_summary',
    'uploaded',
    'pending',
    'e1111111-4444-4111-8111-000000000001',
  ...
  (
    ...
    'a1111111-1111-4111-8111-000000000001',
    'c1111111-1111-4111-8111-000000000001',
    'ramesh_current_opd_note_2026.pdf',
    'application/pdf',
    'medical-documents/a1111111-1111-4111-8111-000000000001/ramesh_current_opd_note_2026.pdf',
    'consultation_note',
    'uploaded',
    'pending',
