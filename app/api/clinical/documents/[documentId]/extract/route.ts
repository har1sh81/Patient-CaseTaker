...
export async function POST(
  ...
  try {
    ...
    const processRes = await extractMedicalInformation(documentId, patientId, { forceReextract });
...
export async function GET(
  ...
  try {
    ...
    const processRes = await getDocumentMedicalInformation(documentId, patientId);
