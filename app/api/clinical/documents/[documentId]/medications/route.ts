...
export async function POST(
  ...
  try {
    ...
    const processRes = await extractDocumentMedications(documentId, patientId, { forceReextract });
...
export async function GET(
  ...
  try {
    ...
    const processRes = await getDocumentMedications(documentId, patientId);
